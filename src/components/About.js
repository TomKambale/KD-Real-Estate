...
import Background from '../assets/greenland.jpg'
// import Background2 from '../assets/wheat.jpg'
// import image1 from '../assets/wheat.jpg'
// import image2 from '../assets/greenland.jpg'
import '../App.css'; 
        ...
        <div className="row">
          <div className="mt-2 col-lg-12">
            <div className="row justify-content-center unstyled">
              <div className="col-4 ">
                <h2 className="mt-4 text-center lead italic ">Your Premier Partner in Land Acquisition and Sales</h2>
              </div>
              <div className="col-4">
